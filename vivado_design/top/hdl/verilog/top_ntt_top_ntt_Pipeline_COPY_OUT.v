...
module top_ntt_top_ntt_Pipeline_COPY_OUT (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] buf_load_reg_152;
wire   [63:0] zext_ln74_fu_115_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [8:0] i_fu_60;
wire   [8:0] add_ln74_fu_109_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln74_fu_103_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln74_fu_103_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln74_fu_109_p2 = (ap_sig_allocacmp_i_1 + 9'd1);
...
assign buf_r_address0 = zext_ln74_fu_115_p1;

assign buf_r_ce0 = buf_r_ce0_local;

assign icmp_ln74_fu_103_p2 = ((ap_sig_allocacmp_i_1 == 9'd256) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = buf_load_reg_152;
...
assign zext_ln74_fu_115_p1 = ap_sig_allocacmp_i_1;

endmodule //top_ntt_top_ntt_Pipeline_COPY_OUT
