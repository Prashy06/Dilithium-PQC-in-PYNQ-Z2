...
entity top_ntt_top_ntt_Pipeline_COPY_OUT is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_ntt_top_ntt_Pipeline_COPY_OUT is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln74_fu_103_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal buf_load_reg_152 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln74_fu_115_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal i_fu_60 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal add_ln74_fu_109_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln74_fu_103_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_60 <= add_ln74_fu_109_p2;
    ...
    add_ln74_fu_109_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv9_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln74_fu_103_p2)
    begin
        if (((icmp_ln74_fu_103_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    buf_r_address0 <= zext_ln74_fu_115_p1(8 - 1 downto 0);
    ...
    icmp_ln74_fu_103_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv9_100) else "0";
    ...
    m_axi_gmem_0_WDATA <= buf_load_reg_152;
    ...
    zext_ln74_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
